...
<h1 align="center"><strong>🛣 Deep Learning based Land Cover Segmentation<h6 align="center">An end-to-end Image Segmentation (CV) project</h6></strong></h1>

![PyTorch - Version](https://img.shields.io/badge/PYTORCH-2.0+-red?style=for-the-badge&logo=pytorch)
![Python - Version](https://img.shields.io/badge/PYTHON-3.9+-blue?style=for-the-badge&logo=python&logoColor=white)
[![Generic badge](https://img.shields.io/badge/License-MIT-<COLOR>.svg?style=for-the-badge)](https://github.com/sheihan-javaid/deep-learning-based-land-cover-segmentation/blob/main/LICENSE) 
[![GitHub Issues](https://img.shields.io/github/issues/sheihan-javaid/deep-learning-based-land-cover-segmentation.svg?style=for-the-badge)](https://github.com/sheihan-javaid/deep-learning-based-land-cover-segmentation/issues)
...
## 💫 Demo <a name="demo"></a>
 ...
 <p align="center">
  <img width="60%" src="assets/training.png">
 </p>
 <p>
...
### 🐳 Setting up and Running the project with Docker <a name="with-docker"></a>
 ...
 ```shell
 git clone git@github.com:sheihan-javaid/deep-learning-based-land-cover-segmentation.git
 ```
 2. Change to the project directory:
 ```shell
 cd deep-learning-based-land-cover-segmentation
 ```
...
@misc{Sheihan:2025,
  ...
  Howpublished = {\url{https://github.com/sheihan-javaid/deep-learning-based-land-cover-segmentation}}
}
```
...
Project is distributed under [MIT License](https://github.com/sheihan-javaid/deep-learning-based-land-cover-segmentation/blob/main/LICENSE)
